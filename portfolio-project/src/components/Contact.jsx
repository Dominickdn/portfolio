  ...
  return (
    <>
      ...
      <div className="flex justify-center ">
        <div className="flex justify-self-center items-center border-b-2 w-1/2 pt-10"></div>
      </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                disabled={loading} 
                className={`bg-slate-500 font-bold py-2 px-4 rounded hover:bg-slate-600 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
              >
